...
namespace OOPPizzaOrder.Api.Controllers
{
    ...
    public class PizzaController : ControllerBase
    {
        ...
        private readonly IPizzaToppingRepository _toppingRepository;

        public PizzaController (IPizzaTypeRepository pizzaTypeRepository,ISizeRepository sizeRepository,IPizzaToppingRepository toppingRepository)
        {
